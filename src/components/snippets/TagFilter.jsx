...
/**
 * TagFilter component for filtering snippets by tags
 * @param {Object} props
 ...
 */
const TagFilter = ({ selectedTags = [], onTagsChange, className = '' }) => {
  ...
  return (
    <DropdownMenu.Root open={isOpen} onOpenChange={setIsOpen}>
      <DropdownMenu.Trigger asChild>
        <button
          className={`tag-filter-button ${hasSelectedTags ? 'active' : ''} ${className}`}
