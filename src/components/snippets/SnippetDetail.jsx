...
/**
 * SnippetDetail component for displaying full snippet information
 * @param {Object} props
 * @param {Object} props.snippet - Snippet object with all details
 * @param {Function} props.onCopy - Copy button click handler
 * @param {Function} props.onUpdate - Update snippet handler
 * @param {Function} props.onDelete - Delete snippet handler
...
const SnippetDetail = ({
  ...
  const isAuthor =
    user &&
    snippet &&
    (user.uid === snippet.authorId || user.email === snippet.authorEmail)
  ...
  const handleEdit = () => {
    ...
    setIsEditing(true)
    setActiveTab('code') // Switch to code tab for editing
  }
  ...
  const handleSave = async () => {
    ...
    try {
      const updatedSnippet = {
        ...
        tags: editedTags || [], // Ensure tags is always an array
      }
              ...
              isAuthor && (
                <div className="author-actions">
                  <button
                    ...
                    className={`tab-button btn-delete ${isDeleteConfirming ? 'confirming' : ''}`}
                    title={
                      isDeleteConfirming
