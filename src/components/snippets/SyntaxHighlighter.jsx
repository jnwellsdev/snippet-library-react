 ...
 * @param {boolean} props.formatCode - Whether to format the code with js-beautify (default: true)
 * @param {string} props.className - Additional CSS classes
 */
const SyntaxHighlighter = ({ code, language = 'markup', formatCode = true, className = '' }) => {
